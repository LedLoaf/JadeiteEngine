...
namespace jadeite
{
	...
	/* Clears the batches and sprite glyphs for the next frame */
	...
	/* Sorts all the sprite glyphs and creates the batches to be drawn */
	...
	/* Adds a sprite with the destination rect, uv rect, layer, texture id, color, and the mat4 model */
	void BatchRenderer::AddSprite(	const glm::vec4& destRect, 
									const glm::vec4& uvRect,
									int layer, GLuint textureID, 
									const Color& color, glm::mat4 model)
	{
	...
	/* Puts the sprite glyphs into the batches container */
