...
namespace jadeite
{
	/* All tunable properties for creating a rigid body. */
	struct PhysicsAttributes
	{
		/* The type of rigid body (STATIC, KINEMATIC, DYNAMIC) */
	...
	/* Physics component allowing an entity to interact with physics */
