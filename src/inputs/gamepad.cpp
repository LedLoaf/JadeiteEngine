...
namespace jadeite
{
	...
	/* Updates all the gamepad buttons for the next frame */
	void Gamepad::Update()
	{
		if (!m_pController)
		{
	...
	/* Sets a specific gamepad button was pressed*/
	...
	/* Sets a specific gamepad button that was released */
	...
	/* Return if a specific gamepad button was pressed*/
	...
	/* Return if a specific gamepad button was just pressed this frame */
	...
	/* Return if a specific gamepad button just released */
	...
	/* Retrieve the axis position of the controller */
	...
	/* Set the axis position of the controller */
	...
	/* Sets and adds a specific controller */
	...
	/* Custom deleting so we can use a shared pointer with SDL_GameController */
