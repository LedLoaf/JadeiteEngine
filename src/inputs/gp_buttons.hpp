...
namespace jadeite 
{
constexpr int GP_BTN_UNKNOWN = -1;
...
constexpr int HAT_CENTERED = 0;
constexpr int HAT_UP = 1;
constexpr int HAT_RIGHT = 2;
constexpr int HAT_UP_RIGHT = 3;
constexpr int HAT_DOWN = 4;
constexpr int HAT_DOWN_RIGHT = 6;
constexpr int HAT_LEFT = 8;
constexpr int HAT_LEFT_UP = 9;
constexpr int HAT_LEFT_DOWN = 12;
}