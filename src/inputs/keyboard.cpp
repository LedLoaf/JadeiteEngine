...
namespace jadeite
{
	/* Default constructor that adds all the keys to the map*/
	Keyboard::Keyboard()
		: m_mapButtons{
	...
	/* Clears the button map for the next frame */
	...
	/* Return if a specific key was pressed */
	...
	/* Return if a specific key has been pressed that frame */
	...
	/* Returns if a specific key was just released this frame */
	...
	/* Returns if any key has been pressed */
